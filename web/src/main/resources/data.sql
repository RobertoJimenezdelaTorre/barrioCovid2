...
insert into tablaproductos (nombre, precio, descripcion, tienda,  stock, elegido)values('Tortitas de maiz', 1, '10 uds', 'Comercios Paco', 10, true);
...
insert into tablaproductos (nombre, precio, descripcion, tienda,  stock, elegido)values('Mejillones en escabeche', 3, 'Lata individual', 'Comercios Paco', 7, false);
insert into tablaproductos (nombre, precio, descripcion, tienda,  stock, elegido)values('Leche',  0.90, 'Un tetrabrik', 'Comercios Paco', 9, true);
